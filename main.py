...
def main():
    ...
    parser.add_argument("--wechat-web", action="store_true", help="微信+Web 联动（手机控制 + 微信监听 + 字幕）")
    ...
    enable_wechat = args.wechat_web or args.wechat
    assistant = Assistant(enable_subtitle=enable_subtitle, enable_wechat=enable_wechat)

    if args.wechat_web:
        assistant.run_wechat_web_mode()
    elif args.wechat:
